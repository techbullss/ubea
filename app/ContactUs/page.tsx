    ...
    <div className="flex flex-col items-center w-full">
      ...
      <div className="w-[90%] md:w-[80%] mx-auto grid grid-cols-1 md:grid-cols-2 gap-10 py-10">
        ...
        <div className="bg-white shadow-lg rounded-lg p-6">
          ...
          <form onSubmit={handleSubmit} action={"https://formsubmit.co/el/confirm/ebeeb46e6758a8f52c833bb976a9ee5f"} method="POST"  className="flex flex-col gap-4 bg-white p-6 ">
      <input
        type="text"
        name="name"
